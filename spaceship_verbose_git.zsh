...
SPACESHIP_VERBOSE_GIT_STATUS_UNTRACKED_COLOR="${SPACESHIP_VERBOSE_GIT_STATUS_UNTRACKED_COLOR=$SPACESHIP_VERBOSE_GIT_COLOR}"
...
spaceship_verbose_git() {
  ...
  if [[ $untracked_count -gt 0 ]]; then
    git_status=$(spaceship::section \
      $SPACESHIP_VERBOSE_GIT_STATUS_UNTRACKED_COLOR \
      "" \
      "$untracked_count$SPACESHIP_VERBOSE_GIT_STATUS_UNTRACKED$separator$git_status" \
      "")
